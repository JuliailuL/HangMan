	...
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			do{
				...
				string path = Path.Combine(Directory.GetCurrentDirectory(), "hangmanwords.txt");
				string solution = TextyThings.ReturnAWordFromTXT(path);
				solution = solution.ToLower();

				/* To show solution before starting the game (presentation purpose). Shows a copy of solution; solution remains unchanged
