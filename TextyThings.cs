...
namespace HangMan
{
	...
	{
		// Function takes a path (string) as input.
		// The function reads each line of a txt-file and adds them to a list of strings
		// By means of random number generation then picks a word from the list and returns it
